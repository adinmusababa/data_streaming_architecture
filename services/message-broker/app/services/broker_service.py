"""Configuration bootstrap for Message Broker Service."""
...
class BrokerConfigService:
    ...
    def __init__(self) -> None:
        self.loader = ConfigLoader(
            ...
            defaults=settings.DEFAULT_BROKER_CONFIG,
            cache_ttl=30,
        )
        self.runtime_config: dict[str, Any] = dict(settings.DEFAULT_BROKER_CONFIG)
    ...
    async def load(self) -> dict[str, Any]:
        ...
        logger.info("Broker config loaded", config=self.runtime_config)
    ...
    def _normalize(self, config: dict[str, Any]) -> dict[str, Any]:
        merged = dict(settings.DEFAULT_BROKER_CONFIG)
